...
tests = [
  ...
  ############## ADD PERSONAL TESTS HERE (examples below) ###############
  # ("testing test",TestCase(os.path.join(file_locations,'testing.circ'), os.path.join(file_locations,'reference_output/testing.out'))),
  # ("bye test",TestCase(os.path.join(file_locations,'bye.circ'), os.path.join(file_locations,'reference_output/bye.out')))
]
